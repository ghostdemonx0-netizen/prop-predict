...
export type HitsRow = {
  ...
  p_ge1_bweight?: number;
  p_ge1_bweight_hist?: number;
  p_ge2_bweight?: number;
  p_ge2_bweight_hist?: number;
  p_ge3_bweight?: number;
  p_ge3_bweight_hist?: number;
  barrel_mult?: number;
  barrel_mult_hist?: number;
};
...
export type TbRow = Omit<HitsRow, "p_ge1" | "p_ge2" | "p_ge3" | "p_ge1_hist" | "p_ge2_hist" | "p_ge3_hist"> & {
  ...
  p_ge4_bweight?: number;
  p_ge4_bweight_hist?: number;
...
export type BoardsGame = { id: string; away: string; home: string; venue: string; note: string; game_time?: string; env?: number; awayPitcher: string; homePitcher: string; awayHitters: BoardHitter[]; homeHitters: BoardHitter[] };
