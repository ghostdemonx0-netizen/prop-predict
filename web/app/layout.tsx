...
import { Bricolage_Grotesque, Hanken_Grotesk, JetBrains_Mono, Space_Grotesk, Chakra_Petch, Rajdhani } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <ClerkProvider>
      <html
        lang="en"
        className={`${display.variable} ${body.variable} ${mono.variable} ${sg.variable} ${cp.variable} ${raj.variable} h-full antialiased`}
      >
